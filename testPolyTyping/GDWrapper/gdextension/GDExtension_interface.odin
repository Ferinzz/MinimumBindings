...
GDExtensionClassCreationInfo4 :: struct {
	...
	is_exposed:            Bool,
	is_runtime:            Bool,
	icon_path:             GDExtensionConstStringPtr, //For some reason does not work with stringnewutf8?? What does the string builder do o.O
	set_func :             GDExtensionClassSet,
	get_func :             GDExtensionClassGet,
	get_property_list_func:GDExtensionClassGetPropertyList,
...
GDExtensionInstanceBindingReferenceCallback :: proc(p_token: rawptr, p_binding: rawptr, p_reference: Bool) -> Bool;
...
GDExtensionClassSet 					:: proc "c" ( p_instance: GDExtensionClassInstancePtr,  p_name: GDExtensionConstStringNamePtr,  p_value: GDExtensionConstVariantPtr) -> Bool
GDExtensionClassGet 					:: proc "c" ( p_instance: GDExtensionClassInstancePtr,  p_name: GDExtensionConstStringNamePtr,  r_ret: GDExtensionVariantPtr) -> Bool
...
GDExtensionClassPropertyCanRevert 		:: proc "c" (p_instance: GDExtensionClassInstancePtr,  p_name: GDExtensionConstStringNamePtr) -> Bool
GDExtensionClassPropertyGetRevert 		:: proc "c" (p_instance: GDExtensionClassInstancePtr,  p_name: GDExtensionConstStringNamePtr,  r_ret: GDExtensionVariantPtr) -> Bool
GDExtensionClassValidateProperty 		:: proc "c" (p_instance: GDExtensionClassInstancePtr,  p_property: ^GDExtensionPropertyInfo) -> Bool
...
GDExtensionClassNotification2 			:: proc "c" ( p_instance:GDExtensionClassInstancePtr, p_what: i32,  p_reversed: Bool);
GDExtensionClassToString 				:: proc "c" ( p_instance:GDExtensionClassInstancePtr, r_is_valid: Bool, p_out: GDExtensionStringPtr);
...
GDExtensionClassCreateInstance2 		:: proc "c" (p_class_userdata: rawptr, p_notify_postinitialize: Bool) -> GDExtensionObjectPtr;
 ...
 */
GDExtensionInterfaceStringNameNewWithLatin1Chars :: proc "c" (r_dest: GDExtensionUninitializedStringNamePtr, p_contents: cstring, p_is_static: Bool)
 ...
 */
GDExtensionInterfacePrintWarningWithMessage :: proc "c" (p_description,p_message,p_function,p_file: cstring, p_line: i32, p_editor_notify: Bool);
